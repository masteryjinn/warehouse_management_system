...
class SupplierDialog(QDialog):
    ...
    def init_ui(self):
        ...
        self.setWindowTitle("👤 Постачальник" if self.supplier else "➕ Новий постачальник")
        self.setStyleSheet(load_dialog_styles())
        ...
        title_text = "📝 Редагування даних" if self.supplier else "🆕 Реєстрація постачальника"
        ...
        self.type_input.addItems(["Виробник", "Дистриб'ютор", "Оптовий продавець"])
        self.type_input.setItemData(0, "manufacturer", Qt.ItemDataRole.UserRole)  # Виробник
        self.type_input.setItemData(1, "distributor", Qt.ItemDataRole.UserRole)  # Дистриб'ютор
        self.type_input.setItemData(2, "wholesaler", Qt.ItemDataRole.UserRole)  # Оптовий продавець
        ...
        btn_text = "💾 Оновити" if self.supplier else "✅ Додати клієнта"
    ...
    def populate_fields(self):
        ...
        self.type_input.setCurrentIndex(self.type_input.findData(self.supplier.get("type", "manufacturer")))
