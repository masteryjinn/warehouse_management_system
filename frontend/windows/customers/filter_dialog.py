...
class FilterDialog(QDialog):
    def __init__(self, parent=None):
        ...
        self.setWindowTitle("🔍 Фільтрація бази клієнтів")
    ...
    def init_ui(self):
        self.setWindowTitle("🔍 Фільтрація бази клієнтів")
        self.setStyleSheet(load_dialog_styles()) # Використовуємо твій загальний стиль
        ...
        # Тип клієнта
        grid.addWidget(QLabel("Тип клієнта:"), 1, 0)
        self.type_input = QComboBox()
        self.type_input.addItems(["Будь-який", "Фізична особа", "Юридична особа"])
        # ПРАВИЛЬНО: (index, value, role)
        self.type_input.setItemData(0, "all", Qt.ItemDataRole.UserRole)
        self.type_input.setItemData(1, "individual", Qt.ItemDataRole.UserRole)
        self.type_input.setItemData(2, "business", Qt.ItemDataRole.UserRole)
